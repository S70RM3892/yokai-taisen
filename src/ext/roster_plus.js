// ============================================================================
// 追加の妖怪（本家の対戦で流行った編成に出てくるのに、同じ働きの妖怪がいなかった分）。
// ここでは仮の名前（久米仙人・油坊）で作り、honke_names.js で本家の名前（ひとまか仙人・あせっか鬼）にする。
//   ひとまか仙人：行動すると、となりの前衛の味方の番を早める（新しい特性「順送り」）
//   あせっか鬼  ：チームにいると、ホイールを回したあとの待ち時間が短くなる（新しい特性「油差し」）
// ============================================================================
